...
namespace GestaoEscolarWeb.Migrations
{
    ...
    [Migration("20250604154435_InitDb")]
            ...
            modelBuilder.Entity("GestaoEscolarWeb.Data.Entities.Student", b =>
                {
                    ...
                    b.Property<string>("UserIdStudentId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GestaoEscolarWeb.Data.Entities.Student", b =>
                {
                    ...
                    b.HasOne("GestaoEscolarWeb.Data.Entities.User", "UserIdStudent")
                        .WithMany()
                        .HasForeignKey("UserIdStudentId");

                    b.Navigation("SchoolClass");

                    b.Navigation("UserAudit");

                    b.Navigation("UserIdStudent");
                });
